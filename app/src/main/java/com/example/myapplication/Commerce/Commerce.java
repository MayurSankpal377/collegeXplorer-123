package com.example.myapplication.Commerce;
...
public class Commerce extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_commerce);  // Change to activity_commerce if it's the new layout
        ...
        listView.setOnItemClickListener((parent, view, position, id) -> {
            ...
            switch (position) {
                case 0:
                    intent = new Intent(Commerce.this, iit_bombay_college.class);
                    break;
                case 1:
                    intent = new Intent(Commerce.this, iit_bombay_college.class);
                    break;
        ...
        backArrow.setOnClickListener(v -> {
            Intent intent = new Intent(Commerce.this, MainActivity.class);  // Create intent for MainActivity
