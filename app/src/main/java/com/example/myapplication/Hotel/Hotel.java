...
public class Hotel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hotel);  // Change to activity_hotel if it's the new layout
        ...
        listView.setOnItemClickListener((parent, view, position, id) -> {
            ...
            switch (position) {
                case 0:
                    intent = new Intent(Hotel.this, iit_bombay_college.class);
                    break;
                case 1:
                    intent = new Intent(Hotel.this, iit_bombay_college.class);
                    break;
        ...
        backArrow.setOnClickListener(v -> {
            Intent intent = new Intent(Hotel.this, MainActivity.class);  // Create intent for MainActivity
