...
public class Science extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_science);  // Change to activity_science if it's the new layout
        ...
        listView.setOnItemClickListener((parent, view, position, id) -> {
            ...
            switch (position) {
                case 0:
                    intent = new Intent(Science.this, iit_bombay_college.class);
                    break;
                case 1:
                    intent = new Intent(Science.this, iit_bombay_college.class);
                    break;
        ...
        backArrow.setOnClickListener(v -> {
            Intent intent = new Intent(Science.this, MainActivity.class);  // Create intent for MainActivity
