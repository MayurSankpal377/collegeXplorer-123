package com.example.myapplication.Agriculture;
...
public class Agriculture extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_agriculture);  // Change to activity_agriculture if it's the new layout
        ...
        listView.setOnItemClickListener((parent, view, position, id) -> {
            ...
            switch (position) {
                case 0:
                    intent = new Intent(Agriculture.this, iit_bombay_college.class);
                    break;
                case 1:
                    intent = new Intent(Agriculture.this, iit_bombay_college.class);
                    break;
        ...
        backArrow.setOnClickListener(v -> {
            Intent intent = new Intent(Agriculture.this, MainActivity.class);  // Create intent for MainActivity
